...
// function getRoomComputersByUser(user) {       // datalari(komputerleri) tek-tek gostermek istesen bele
...
// function getRoomComputersByUser(user) {       // datalari(komputerleri) array sheklinde gostermek istesen bele
//     let rooms = user.company.rooms;
